                ...
                uniqueTimeSlots.forEach((time, index) => {
                    ...
                    weekDays.forEach((d) => {
                        ...
                        if (unavailability || blockedPeriod) {
                            ...
                            row += `<td class="slot-cell ${pastClass}" data-date="${dateAttr}" data-slot="${time}" data-appointment-id="${appointment.id}">${createCardHtml(appointment)}</td>`;
                        } else {
                ...
                daySlots.forEach((slotObj) => {
                    ...
                    if (slotObj.isBreak) {
                        ...
                        if (unavailability || blockedPeriod) {
                            ...
                            row += `<td class="slot-cell day-view-slot ${pastClass}" data-date="${dateAttr}" data-slot="${slotObj.time}" data-appointment-id="${appointment.id}" style="padding: 0; background-color: #ffffff;">${createCardHtml(appointment, true)}</td>`;
                        } else {
